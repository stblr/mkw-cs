...
CHUNKS = {
    ...
    'K': [
        Chunk(0x80004000, 0x800074d8, 0x80004000),
        Chunk(0x800077c8, 0x800079d0, 0x80007894),
        ...
        Chunk(0x802a4080, 0x8038917c, 0x80292080),
    ],
}
...
for name, dst_binary in DST_BINARIES[args.region].items():
    write_symbol(out_file, f'{name}Start', dst_binary.start)
    write_symbol(out_file, f'{name}End', dst_binary.end)
    out_file.write('\n')
